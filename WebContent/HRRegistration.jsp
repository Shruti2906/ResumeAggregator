   ...
   <div class="container">
     ...
     <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="HRRegistration.jsp" class="nav-link">HR Registration</a></li>
    ...
    <div class="row">
      <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
						...
						<div class="custom-bar-chart">
							<h1 align="center">HR Registration Form </h1>
						</div>
						<div class="custom-bar-chart">
								...
								<table align="center" border="5" cellpadding="10" cellspacing="10">
									<tr>
										...
										<td><input type="text" name="fname"
											placeholder=" FristName" required></td>
									...
									<tr>
										...
										<td><input type="text" name="mail"
											placeholder=" aa@gmail.com" required></td>
										<td><input type="text" name="contact" maxlength="10"
									...
									<tr>
										...
										<td><input type="text" name="exp" placeholder="Experence"
											required></td>
									...
									<tr>
										<td><h6>Company:</h6></td>
										<td><input type="text" name="company" maxlength="10"
											placeholder="Company" required></td>
										<td><input type="uname" name="uname" placeholder="Uname"
											required></td>
