...
<body>
	<%
		if (request.getParameter("done") != null) {
			out.println(" <script>alert(' Candidate Registration Successfully ...')</script>");
		}
	%>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="CandidateRegistration.jsp" class="nav-link">New Registration</a></li>
      	...
      	<div class="row d-md-flex no-gutters slider-text align-items-end js-fullheight justify-content-end">
	        ...
	        <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
				...
				<div align="center">
				 ...
				 <h2><span style="font-size:22px; color: red">Candidate Login</span></h2>
				</div>	
			...
			<form action="Candidate" method="post">
				<table align="center" cellpadding="5" cellspacing="5">
					...
					<tr>
				     	<td align="center"><input class="btn_1" type="submit" value="SignIn" /></td>
				     	<td align="center"><a href="CandidateRegistration.jsp" class="btn_2"><i>Not Register....?</i></a></td>
				     </tr>
				</table>
			</form>    
				            </div>
