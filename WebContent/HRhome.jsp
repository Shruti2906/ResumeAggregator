...
<%
	if (request.getParameter("done") != null) {
		out.println(" <script>alert(' HR Login Successfully ...')</script>");
	}
%>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="HRhome.jsp" class="nav-link">Home</a></li>
      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-end js-fullheight justify-content-end">
	        ...
	        <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
				...
				<div align="center">
				 <img src="img/admin.png" width="120" height="90">&nbsp;&nbsp;&nbsp;
				 <h2><span style="font-size:22px; color: red">HR Section Home Page</span></h2>
				</div>	
		
				<div class="border-head">
					<h3 align="center">Welcome <%=session.getAttribute("uname")%> to HR Home Page </h3> 
				</div>
				<br> <br>
