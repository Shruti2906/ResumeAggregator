   ...
   <div class="container">
     ...
     <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="AvailableHr.jsp" class="nav-link">HR Managers</a></li>
    ...
    <div class="row">
      <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
				...
				<div class="custom-bar-chart">
					<h1 align="center">Available HR Details </h1>
						</div>
						<div class="custom-bar-chart">
							<table align="center" border="5" cellpadding="10" cellspacing="10">
								...
								<%
									...
									ResultSet rs = st1.executeQuery("select * from hr");
			                        while (rs.next())
								   {
			                        %>
			                        <tr>
