      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-end js-fullheight justify-content-end">
	        ...
	        <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
				...
				<div align="center">
				 <img src="img/admin.jpg" width="120" height="110">&nbsp;&nbsp;&nbsp;
				 <h2><span style="font-size:22px; color: red">Admin Login</span></h2>
				</div>	
			...
			<form action="Admin" method="post">
				<table align="center" cellpadding="5" cellspacing="5">
					...
					<tr>
				     	<td align="center" colspan="2"><input class="btn_1" type="submit" value="SignIn" /></td>
				     </tr>
				</table>
			</form>    
				            </div>
